"""
Django settings for note_app_server project.
...
SECRET_KEY = 'django-insecure-ge0c1k_wr0x+z7y@^pm7q_1w)hv5gc^&ublptd)x^x3m%s2t+y'
...
WSGI_APPLICATION = 'note_app_server.wsgi.application'
